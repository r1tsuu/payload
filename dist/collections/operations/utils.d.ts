...
export declare const buildAfterOperation: <TOperationGeneric extends CollectionSlug, O extends keyof AfterOperationMap<TOperationGeneric> = keyof AfterOperationMap<TOperationGeneric>>(operationArgs: Omit<AfterOperationArg<TOperationGeneric>, "req"> & {
    operation: O;
